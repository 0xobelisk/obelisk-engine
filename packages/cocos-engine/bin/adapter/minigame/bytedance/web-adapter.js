...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var MouseEvent = exports["default"] = /*#__PURE__*/_createClass(function MouseEvent() {
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var TouchEvent = exports["default"] = /*#__PURE__*/_createClass(function TouchEvent(type) {
...
var HTMLMediaElement = exports["default"] = /*#__PURE__*/function (_HTMLElement) {
  function HTMLMediaElement(type) {
    ...
    return _callSuper(this, HTMLMediaElement, [type]);
  }
...
var _tt$getSystemInfoSync = tt.getSystemInfoSync(),
  ...
  devicePixelRatio = exports.devicePixelRatio = _tt$getSystemInfoSync.devicePixelRatio;
...
var _GameGlobal = GameGlobal,
  setTimeout = exports.setTimeout = _GameGlobal.setTimeout,
  setInterval = exports.setInterval = _GameGlobal.setInterval,
  clearTimeout = exports.clearTimeout = _GameGlobal.clearTimeout,
  clearInterval = exports.clearInterval = _GameGlobal.clearInterval,
  requestAnimationFrame = exports.requestAnimationFrame = _GameGlobal.requestAnimationFrame,
  cancelAnimationFrame = exports.cancelAnimationFrame = _GameGlobal.cancelAnimationFrame;
