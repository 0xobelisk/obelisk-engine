System.register("q-bundled:///fs/cocos/scene-graph/prefab/prefab-info.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../core/index.js", "../../core/data/index.js", "../component.js", "../node.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      _export("TargetInfo", TargetInfo = (_dec = ccclass('cc.TargetInfo'), _dec2 = type([CCString]), _dec(_class = (_class2 = function TargetInfo() {
      ...
      _export("TargetOverrideInfo", TargetOverrideInfo = (_dec3 = ccclass('cc.TargetOverrideInfo'), _dec4 = type(CCObject), _dec5 = type(TargetInfo), _dec6 = type([CCString]), _dec7 = type(Node), _dec8 = type(TargetInfo), _dec3(_class4 = (_class5 = function TargetOverrideInfo() {
      ...
      _export("CompPrefabInfo", CompPrefabInfo = (_dec9 = ccclass('cc.CompPrefabInfo'), _dec9(_class7 = (_class8 = function CompPrefabInfo() {
      ...
      _export("PropertyOverrideInfo", PropertyOverrideInfo = (_dec10 = ccclass('CCPropertyOverrideInfo'), _dec11 = type(TargetInfo), _dec12 = type([CCString]), _dec10(_class10 = (_class11 = /*#__PURE__*/function () {
      ...
      _export("MountedChildrenInfo", MountedChildrenInfo = (_dec13 = ccclass('cc.MountedChildrenInfo'), _dec14 = type(TargetInfo), _dec15 = type([Node]), _dec13(_class13 = (_class14 = /*#__PURE__*/function () {
      ...
      _export("MountedComponentsInfo", MountedComponentsInfo = (_dec16 = ccclass('cc.MountedComponentsInfo'), _dec17 = type(TargetInfo), _dec18 = type([Component]), _dec16(_class16 = (_class17 = /*#__PURE__*/function () {
       ...
       * @internal
       */
      _export("PrefabInstance", PrefabInstance = (_dec19 = ccclass('cc.PrefabInstance'), _dec20 = type(Node), _dec21 = type([MountedChildrenInfo]), _dec22 = type([MountedComponentsInfo]), _dec23 = type([PropertyOverrideInfo]), _dec24 = type([TargetInfo]), _dec19(_class19 = (_class20 = /*#__PURE__*/function () {
      ...
      _export("PrefabInfo", PrefabInfo = (_dec25 = ccclass('cc.PrefabInfo'), _dec26 = type(Node), _dec27 = type(PrefabInstance), _dec28 = type([TargetOverrideInfo]), _dec25(_class22 = (_class23 = function PrefabInfo() {
