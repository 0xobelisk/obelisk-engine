System.register("q-bundled:///fs/cocos/animation/marionette/state-machine/condition/binding/editor.js", ["../../../../../../../virtual/internal%253Aconstants.js", "../../../../../core/index.js", "./binding.js"], function (_export, _context) {
  ...
  function getOrCreateTCBindingTypeInfo(target) {
    ...
    var info = tcnBindingTypeInfoMap.get(constructor);
    if (!info) {
      info = {};
  ...
  return {
    ...
    execute: function () {
      ...
      _export("provide", provide = function provide() {
        for (var _len = arguments.length, valueTypes = new Array(_len), _key = 0; _key < _len; _key++) {
          valueTypes[_key] = arguments[_key];
        }
        return !EDITOR ? function () {} : function (target) {
          var info = getOrCreateTCBindingTypeInfo(target);
      ...
      _export("support", support = function support(transitionSourceFilter) {
        return !EDITOR ? function () {} : function (target) {
          var info = getOrCreateTCBindingTypeInfo(target);
