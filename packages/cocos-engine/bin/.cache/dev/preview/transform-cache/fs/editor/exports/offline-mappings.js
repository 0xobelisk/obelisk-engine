  ...
  return {
    ...
    execute: function () {
      ...
      _export("getShaderStage", getShaderStage = function getShaderStage(name) {
        return ShaderStageFlagBit[name.toUpperCase()];
      });
      _export("getDescriptorType", getDescriptorType = function getDescriptorType(name) {
        return DescriptorType[name.toUpperCase()];
      });
      ...
      _export("getMemoryAccessFlag", getMemoryAccessFlag = function getMemoryAccessFlag(access) {
        if (access === 'writeonly') {
