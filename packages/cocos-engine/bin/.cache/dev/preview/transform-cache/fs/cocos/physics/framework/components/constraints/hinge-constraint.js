System.register("q-bundled:///fs/cocos/physics/framework/components/constraints/hinge-constraint.js", ["../../../../core/data/decorators/index.js", "../../../../../../virtual/internal%253Aconstants.js", "./constraint.js", "../../../../core/index.js", "../../physics-enum.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       * @zh 铰链约束的限制数据。
       */
      _export("HingeLimitData", HingeLimitData = (_dec = ccclass('cc.HingeLimitData'), _dec2 = formerlySerializedAs('enabled'), _dec3 = formerlySerializedAs('upperLimit'), _dec4 = formerlySerializedAs('lowerLimit'), _dec5 = type(CCBoolean), _dec6 = type(CCFloat), _dec7 = type(CCFloat), _dec(_class = (_class2 = /*#__PURE__*/function () {
       ...
       * @zh 铰链约束的马达数据。
       */
      _export("HingeMotorData", HingeMotorData = (_dec8 = ccclass('cc.HingeMotorData'), _dec9 = formerlySerializedAs('enabled'), _dec10 = formerlySerializedAs('motorVelocity'), _dec11 = formerlySerializedAs('motorForceLimit'), _dec12 = type(CCBoolean), _dec13 = type(CCFloat), _dec14 = type(CCFloat), _dec8(_class4 = (_class5 = /*#__PURE__*/function () {
