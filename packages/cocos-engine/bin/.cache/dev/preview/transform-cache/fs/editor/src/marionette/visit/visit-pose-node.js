System.register("q-bundled:///fs/editor/src/marionette/visit/visit-pose-node.js", ["../../../../cocos/animation/marionette/animation-graph.js", "../../../../cocos/animation/marionette/pose-graph/pose-nodes/state-machine.js", "../../../../cocos/animation/marionette/pose-graph/pose-node.js"], function (_export, _context) {
  ...
  var ProceduralPoseState, PoseNodeStateMachine, PoseNode, _marked, _marked2, _marked3;
  ...
  function visitPoseNodeInLayer(layer) {
    var _iterator, _step, _step$value, stashId, stash;
    return _regeneratorRuntime().wrap(function visitPoseNodeInLayer$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.delegateYield(visitPoseNodesInStateMachine(layer.stateMachine, ['']), "t0", 1);
        case 1:
          _iterator = _createForOfIteratorHelperLoose(layer.stashes());
        case 2:
          if ((_step = _iterator()).done) {
            _context2.next = 7;
            break;
          }
          _step$value = _step.value, stashId = _step$value[0], stash = _step$value[1];
          return _context2.delegateYield(visitPoseNodeInPoseGraph(stash.graph, [stashId]), "t1", 5);
        case 5:
          _context2.next = 2;
          break;
        case 7:
  ...
  function visitPoseNodeInPoseGraph(poseGraph, root) {
    var _iterator2, _step2, _node;
    return _regeneratorRuntime().wrap(function visitPoseNodeInPoseGraph$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _iterator2 = _createForOfIteratorHelperLoose(poseGraph.nodes());
        case 1:
          ...
          _node = _step2.value;
          if (!(_node instanceof PoseNode)) {
            _context3.next = 6;
            break;
          }
          _context3.next = 6;
          return [_node, poseGraph].concat(root);
        case 6:
          if (!(_node instanceof PoseNodeStateMachine)) {
            _context3.next = 8;
            break;
          }
          return _context3.delegateYield(visitPoseNodesInStateMachine(_node.stateMachine, [].concat(root)), "t0", 8);
        case 8:
          _context3.next = 1;
          break;
        case 10:
  ...
  function visitPoseNodesInStateMachine(stateMachine, root) {
    var _iterator3, _step3, state;
    return _regeneratorRuntime().wrap(function visitPoseNodesInStateMachine$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 1:
          ...
          return _context4.delegateYield(visitPoseNodeInPoseGraph(state.graph, [].concat(root)), "t0", 5);
        case 5:
          _context4.next = 1;
          break;
        case 7:
  ...
  return {
    ...
    execute: function () {
      _marked = /*#__PURE__*/regeneratorRuntime.mark(visitPoseNodeInLayer);
      _marked2 = /*#__PURE__*/regeneratorRuntime.mark(visitPoseNodeInPoseGraph);
      _marked3 = /*#__PURE__*/regeneratorRuntime.mark(visitPoseNodesInStateMachine);
    }
  };
});