System.register("q-bundled:///fs/editor/src/marionette/pose-graph/drag/registry.js", ["../../../../../exports/base.js"], function (_export, _context) {
  ...
  var assertIsTrue, _marked, assetDragHandlerRegistry, handlerIdGenerator;
  ...
  function getPoseGraphAssetDragHandlersMap() {
    var _iterator, _step, _step$value, assetType, register, info, _i, _Object$entries, _Object$entries$_i, handlerId, handler;
    return _regeneratorRuntime().wrap(function getPoseGraphAssetDragHandlersMap$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _iterator = _createForOfIteratorHelperLoose(assetDragHandlerRegistry.entries());
        case 1:
          if ((_step = _iterator()).done) {
            _context2.next = 9;
            break;
          }
          _step$value = _step.value, assetType = _step$value[0], register = _step$value[1];
          info = {
            handlers: {}
          };
          for (_i = 0, _Object$entries = Object.entries(register.handlers); _i < _Object$entries.length; _i++) {
            _Object$entries$_i = _Object$entries[_i], handlerId = _Object$entries$_i[0], handler = _Object$entries$_i[1];
  ...
  function createPoseNodeOnAssetDrag(asset, handlerId) {
    var assetType = asset.constructor;
    var assetDragRegister = assetDragHandlerRegistry.get(assetType);
    if (!assetDragRegister) {
      console.warn("There has any no handlers for asset type " + assetType);
      return;
    }
    var handler = assetDragRegister.handlers[handlerId];
    if (!handler) {
  ...
  function registerCreatePoseNodeOnAssetDragHandler(assetType, handler) {
    var assetDragHandlerRegister = assetDragHandlerRegistry.get(assetType);
    ...
    var handlerId = handlerIdGenerator++;
  ...
  return {
    ...
    execute: function () {
      _marked = /*#__PURE__*/regeneratorRuntime.mark(getPoseGraphAssetDragHandlersMap);
