System.register("q-bundled:///fs/cocos/core/math/color.js", ["../data/class.js", "../value-types/value-type.js", "./utils.js", "../global-exports.js", "../data/utils/asserts.js", "./vec4.js", "./vec3.js"], function (_export, _context) {
  ...
  var CCClass, ValueType, clamp, EPSILON, legacyCC, assertIsTrue, Vec4, Vec3, _class, toFloat, Color, SRGB_8BIT_TO_LINEAR, i;
  ...
  function linearToSrgb(x) {
    if (x <= 0) return 0;else if (x >= 1) return 1;else if (x < 0.0031308) return x * 12.92;else return Math.pow(x, 1 / 2.4) * 1.055 - 0.055;
  }
    ...
    execute: function () {
      ...
      _export("Color", Color = /*#__PURE__*/function (_ValueType) {
        ...
        Color.equals = function equals(a, b, epsilon) {
          ...
          var hasInf = Math.abs(a.r) === Infinity || Math.abs(a.g) === Infinity || Math.abs(a.b) === Infinity || Math.abs(a.a) === Infinity;
        ...
        _proto.fromHEX = function fromHEX(hex) {
          ...
          var r = hexNumber >>> 24;
          var g = (hexNumber & 0x00ff0000) >>> 16;
          var b = (hexNumber & 0x0000ff00) >>> 8;
          var a = hexNumber & 0x000000ff;
