System.register("q-bundled:///fs/cocos/scene-graph/scene-globals.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "../asset/assets/texture-cube.js", "../core/data/utils/attribute.js", "../core/math/index.js", "../render-scene/scene/ambient.js", "../render-scene/scene/shadows.js", "../render-scene/scene/skybox.js", "../render-scene/scene/fog.js", "../core/global-exports.js", "../core/platform/debug.js", "../asset/assets/material.js", "../core/index.js", "./node-event.js", "../render-scene/scene/post-settings.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       * @zh 场景的环境光照相关配置
       */
      _export("AmbientInfo", AmbientInfo = (_dec = ccclass('cc.AmbientInfo'), _dec2 = visible(function () {
      ...
      }), _dec3 = tooltip('i18n:ambient.skyLightingColor'), _dec4 = type(CCFloat), _dec5 = tooltip('i18n:ambient.skyIllum'), _dec6 = range([0, Number.POSITIVE_INFINITY, 100]), _dec7 = visible(function () {
        var scene = legacyCC.director.getScene();
        var skybox = scene.globals.skybox;
        if (skybox.useIBL && skybox.applyDiffuseMap) {
          return false;
      ...
      }), _dec8 = tooltip('i18n:ambient.groundLightingColor'), _dec9 = formerlySerializedAs('_skyColor'), _dec10 = formerlySerializedAs('_skyIllum'), _dec11 = formerlySerializedAs('_groundAlbedo'), _dec(_class = (_class2 = /*#__PURE__*/function () {
      ...
      _export("SkyboxInfo", SkyboxInfo = (_dec12 = ccclass('cc.SkyboxInfo'), _dec13 = tooltip('i18n:skybox.enabled'), _dec14 = type(EnvironmentLightingType), _dec15 = tooltip('i18n:skybox.EnvironmentLightingType'), _dec16 = tooltip('i18n:skybox.useHDR'), _dec17 = type(TextureCube), _dec18 = tooltip('i18n:skybox.envmap'), _dec19 = type(CCFloat), _dec20 = range([0, 360, 1]), _dec21 = tooltip('i18n:skybox.rotationAngle'), _dec22 = visible(function () {
        ...
        _proto2.setMaterialProperty = function setMaterialProperty(name, val, passIdx) {
          ...
          if (this._resource.enabled && this._resource.editableMaterial) {
            ...
            this._resource.editableMaterial.passes.forEach(function (pass) {
              pass.update();
            });
          }
        };
      ...
      _export("FogInfo", FogInfo = (_dec38 = ccclass('cc.FogInfo'), _dec39 = tooltip('i18n:fog.enabled'), _dec40 = displayOrder(0), _dec41 = tooltip('i18n:fog.accurate'), _dec42 = displayOrder(0), _dec43 = tooltip('i18n:fog.fogColor'), _dec44 = type(FogType), _dec45 = displayOrder(1), _dec46 = tooltip('i18n:fog.type'), _dec47 = visible(function () {
        ...
        return this._type === FogType.LAYERED;
      }), _dec69 = type(CCFloat), _dec70 = rangeStep(0.01), _dec71 = tooltip('i18n:fog.fogRange'), _dec38(_class7 = (_class8 = (_class9 = /*#__PURE__*/function () {
        function FogInfo() {
      ...
      _export("ShadowsInfo", ShadowsInfo = (_dec72 = ccclass('cc.ShadowsInfo'), _dec73 = tooltip('i18n:shadow.enabled'), _dec74 = tooltip('i18n:shadow.type'), _dec75 = type(ShadowType), _dec76 = tooltip('i18n:shadow.shadowColor'), _dec77 = visible(function () {
        ...
        return this._type === ShadowType.ShadowMap;
      }), _dec72(_class10 = (_class11 = /*#__PURE__*/function () {
       ...
       * @zh 基于八叉树的场景剔除配置
       */
      _export("OctreeInfo", OctreeInfo = (_dec92 = ccclass('cc.OctreeInfo'), _dec93 = tooltip('i18n:octree_culling.enabled'), _dec94 = tooltip('i18n:octree_culling.minPos'), _dec95 = displayName('World MinPos'), _dec96 = tooltip('i18n:octree_culling.maxPos'), _dec97 = displayName('World MaxPos'), _dec98 = range([4, 12, 1]), _dec99 = type(CCInteger), _dec100 = tooltip('i18n:octree_culling.depth'), _dec92(_class13 = (_class14 = /*#__PURE__*/function () {
        function OctreeInfo() {
      ...
      _export("PostSettingsInfo", PostSettingsInfo = (_dec110 = ccclass('cc.PostSettingsInfo'), _dec111 = type(ToneMappingType), _dec112 = tooltip('i18n:tone_mapping.toneMappingType'), _dec110(_class19 = (_class20 = /*#__PURE__*/function () {
       ...
       * @zh 光照探针配置
       */
      _export("LightProbeInfo", LightProbeInfo = (_dec113 = ccclass('cc.LightProbeInfo'), _dec114 = range([0, 100, 1]), _dec115 = type(CCFloat), _dec116 = tooltip('i18n:light_probe.giScale'), _dec117 = displayName('GIScale'), _dec118 = range([64, 65535, 1]), _dec119 = type(CCInteger), _dec120 = tooltip('i18n:light_probe.giSamples'), _dec121 = displayName('GISamples'), _dec122 = range([1, 4, 1]), _dec123 = type(CCInteger), _dec124 = tooltip('i18n:light_probe.bounces'), _dec125 = range([0.0, 0.05, 0.001]), _dec126 = type(CCFloat), _dec127 = tooltip('i18n:light_probe.reduceRinging'), _dec128 = tooltip('i18n:light_probe.showWireframe'), _dec129 = tooltip('i18n:light_probe.showConvex'), _dec130 = range([0, 100, 1]), _dec131 = type(CCFloat), _dec132 = tooltip('i18n:light_probe.lightProbeSphereVolume'), _dec113(_class22 = (_class23 = /*#__PURE__*/function () {
       ...
       */
      _export("SceneGlobals", SceneGlobals = (_dec133 = ccclass('cc.SceneGlobals'), _dec134 = type(SkyboxInfo), _dec133(_class25 = (_class26 = /*#__PURE__*/function () {
