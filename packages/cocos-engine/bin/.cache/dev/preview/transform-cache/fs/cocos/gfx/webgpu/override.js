  ...
  return {
    ...
    execute: function () {
      WEBGPU && promiseForWebGPUInstantiation.then(function () {
        ...
        // immutable excluded
        [Device, Queue, Swapchain, Buffer, Texture, Shader, InputAssembler, RenderPass, Framebuffer, DescriptorSet, DescriptorSetLayout, PipelineState, CommandBuffer].forEach(function (ele) {
          var oldDestroy = ele.prototype.destroy;
