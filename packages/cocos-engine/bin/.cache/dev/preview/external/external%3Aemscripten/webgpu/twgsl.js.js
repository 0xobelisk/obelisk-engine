System.register(['../../_rollupPluginBabelHelpers-4bcbdaa7.js'], function (exports) {
    'use strict';
    var _typeof;
    return {
        ...
        execute: function () {
            ...
            var Module = function Module(_Module) {
              ...
              var INITIAL_MEMORY = _Module["INITIAL_MEMORY"] || 16777216;
              var __ATPRERUN__ = [];
              var __ATINIT__ = [];
              var __ATPOSTRUN__ = [];
              ...
              var asm = createWasm();
              var ___wasm_call_ctors = _Module["___wasm_call_ctors"] = function () {
                return (___wasm_call_ctors = _Module["___wasm_call_ctors"] = _Module["asm"]["p"]).apply(null, arguments);
              };
              var _test = _Module["_test"] = function () {
                return (_test = _Module["_test"] = _Module["asm"]["q"]).apply(null, arguments);
              };
              var _spirv_to_wgsl = _Module["_spirv_to_wgsl"] = function () {
                return (_spirv_to_wgsl = _Module["_spirv_to_wgsl"] = _Module["asm"]["r"]).apply(null, arguments);
              };
              ...
              var _free = _Module["_free"] = function () {
                return (_free = _Module["_free"] = _Module["asm"]["u"]).apply(null, arguments);
              };
            ...
            var initialize = function initialize(wasmPath) {
            ...
            var instance;
            var twgsl = exports('default', (function (wasmPath) {
              if (!instance) {
