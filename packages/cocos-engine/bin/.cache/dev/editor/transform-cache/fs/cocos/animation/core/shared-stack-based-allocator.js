System.register("q-bundled:///fs/cocos/animation/core/shared-stack-based-allocator.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/index.js"], function (_export, _context) {
  ...
  var DEBUG, assertIsTrue, binarySearchEpsilon, SharedMemoryPage, PagedStack, SharedMemorySlice, SharedStackBasedAllocator, SharedStackBasedAllocatorManager, allocatorPageCountTag, onStackPurgedTag;
  _export("SharedStackBasedAllocatorManager", void 0);
  return {
    ...
    execute: function () {
      ...
      SharedMemoryPage = class SharedMemoryPage {
      ...
      SharedMemorySlice = class SharedMemorySlice {
       ...
       */
      SharedStackBasedAllocator = class SharedStackBasedAllocator {
      ...
      _export("SharedStackBasedAllocatorManager", SharedStackBasedAllocatorManager = class SharedStackBasedAllocatorManager {
