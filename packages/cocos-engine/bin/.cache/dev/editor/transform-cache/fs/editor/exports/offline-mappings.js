System.register("q-bundled:///fs/editor/exports/offline-mappings.js", ["../../cocos/gfx/index.js", "../../cocos/rendering/define.js", "../../cocos/core/index.js"], function (_export, _context) {
  "use strict";

  var Address, BlendFactor, BlendOp, ColorMask, ComparisonFunc, CullMode, DynamicStateFlagBit, Filter, Format, FormatInfos, FormatType, GetTypeSize, PolygonMode, PrimitiveMode, ShadeModel, ShaderStageFlagBit, StencilOp, Type, DescriptorType, SamplerInfo, MemoryAccessBit, Sampler, RenderPassStage, RenderPriority, SetIndex, murmurhash2_32_gc, typeMap, isSampler, isPaddedMatrix, formatMap, getFormat, getShaderStage, getDescriptorType, isNormalized, getMemoryAccessFlag, passParams, effectStructure;
  return {
    setters: [function (_cocosGfxIndexJs) {
      Address = _cocosGfxIndexJs.Address;
      BlendFactor = _cocosGfxIndexJs.BlendFactor;
      BlendOp = _cocosGfxIndexJs.BlendOp;
      ColorMask = _cocosGfxIndexJs.ColorMask;
      ComparisonFunc = _cocosGfxIndexJs.ComparisonFunc;
      CullMode = _cocosGfxIndexJs.CullMode;
      DynamicStateFlagBit = _cocosGfxIndexJs.DynamicStateFlagBit;
      Filter = _cocosGfxIndexJs.Filter;
      Format = _cocosGfxIndexJs.Format;
      FormatInfos = _cocosGfxIndexJs.FormatInfos;
      FormatType = _cocosGfxIndexJs.FormatType;
      GetTypeSize = _cocosGfxIndexJs.GetTypeSize;
      PolygonMode = _cocosGfxIndexJs.PolygonMode;
      PrimitiveMode = _cocosGfxIndexJs.PrimitiveMode;
      ShadeModel = _cocosGfxIndexJs.ShadeModel;
      ShaderStageFlagBit = _cocosGfxIndexJs.ShaderStageFlagBit;
      StencilOp = _cocosGfxIndexJs.StencilOp;
      Type = _cocosGfxIndexJs.Type;
      DescriptorType = _cocosGfxIndexJs.DescriptorType;
      SamplerInfo = _cocosGfxIndexJs.SamplerInfo;
      MemoryAccessBit = _cocosGfxIndexJs.MemoryAccessBit;
      Sampler = _cocosGfxIndexJs.Sampler;
    }, function (_cocosRenderingDefineJs) {
      RenderPassStage = _cocosRenderingDefineJs.RenderPassStage;
      RenderPriority = _cocosRenderingDefineJs.RenderPriority;
      SetIndex = _cocosRenderingDefineJs.SetIndex;
    }, function (_cocosCoreIndexJs) {
      murmurhash2_32_gc = _cocosCoreIndexJs.murmurhash2_32_gc;
    }],
    execute: function () {
      ...
      _export("isSampler", isSampler = type => type >= Type.SAMPLER1D);
      _export("isPaddedMatrix", isPaddedMatrix = type => type >= Type.MAT2 && type < Type.MAT4);
      ...
      _export("getFormat", getFormat = name => Format[name.toUpperCase()]);
      _export("getShaderStage", getShaderStage = name => ShaderStageFlagBit[name.toUpperCase()]);
      _export("getDescriptorType", getDescriptorType = name => DescriptorType[name.toUpperCase()]);
      _export("isNormalized", isNormalized = format => {
        const type = FormatInfos[format] && FormatInfos[format].type;
        return type === FormatType.UNORM || type === FormatType.SNORM;
      });
      _export("getMemoryAccessFlag", getMemoryAccessFlag = access => {
        if (access === 'writeonly') {
      ...
      _export("Sampler", Sampler);
      _export("SamplerInfo", SamplerInfo);
