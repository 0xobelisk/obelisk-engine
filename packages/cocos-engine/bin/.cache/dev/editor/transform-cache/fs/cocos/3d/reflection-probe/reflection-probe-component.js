  ...
  return {
    ...
    execute: function () {
      ...
      _export("ReflectionProbe", ReflectionProbe = (_dec = ccclass('cc.ReflectionProbe'), _dec2 = menu('Rendering/ReflectionProbe'), _dec3 = help('i18n:cc.ReflectionProbe'), _dec4 = type(Vec3), _dec5 = type(Enum(ProbeType)), _dec6 = visible(function () {
        ...
        return this.probeType === ProbeType.CUBE;
      }), _dec17 = type(CCBoolean), _dec18 = tooltip('i18n:reflection_probe.fastBake'), _dec19 = type(TextureCube), _dec20 = visible(false), _dec(_class = _dec2(_class = executeInEditMode(_class = playOnFocus(_class = _dec3(_class = (_class2 = (_class3 = class ReflectionProbe extends Component {
        constructor(...args) {
          super(...args);
      ...
      }, _class3.DEFAULT_CUBE_SIZE = new Vec3(1, 1, 1), _class3.DEFAULT_PLANER_SIZE = new Vec3(5, 0.5, 5), _class3), (_initializer = _applyDecoratedInitializer(_class2.prototype, "_resolution", [serializable], function () {
        return 256;
