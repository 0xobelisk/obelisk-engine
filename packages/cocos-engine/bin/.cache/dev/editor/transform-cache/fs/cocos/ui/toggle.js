    ...
    execute: function () {
      ...
      _export("Toggle", Toggle = (_dec = ccclass('cc.Toggle'), _dec2 = help('i18n:cc.Toggle'), _dec3 = executionOrder(110), _dec4 = menu('UI/Toggle'), _dec5 = requireComponent(UITransform), _dec6 = displayOrder(1), _dec7 = tooltip('i18n:toggle.isChecked'), _dec8 = type(Sprite), _dec9 = displayOrder(1), _dec10 = tooltip('i18n:toggle.checkMark'), _dec11 = type([ComponentEventHandler]), _dec12 = tooltip('i18n:toggle.check_events'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_class3 = class Toggle extends Button {
        constructor(...args) {
           ...
           * Toggle 按钮的点击事件列表。
           */
          this.checkEvents = _initializer && _initializer();
          this._isChecked = _initializer2 && _initializer2();
          this._checkMark = _initializer3 && _initializer3();
        }
        /**
         * @en
