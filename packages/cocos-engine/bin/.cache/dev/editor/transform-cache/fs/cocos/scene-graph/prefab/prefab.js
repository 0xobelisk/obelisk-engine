System.register("q-bundled:///fs/cocos/scene-graph/prefab/prefab.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../serialization/instantiate-jit.js", "../../core/index.js", "../../core/value-types/index.js", "../../asset/assets/asset.js", "../node.js", "../../core/global-exports.js", "../../core/platform/debug.js", "../../core/utils/jsb-utils.js", "./utils.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       * @zh 预制资源类。
       */
      _export("Prefab", Prefab = (_dec = ccclass('cc.Prefab'), _dec(_class = (_class2 = (_class3 = class Prefab extends Asset {
        constructor() {
          super();
          /**
      ...
      }, _class3.OptimizationPolicy = OptimizationPolicy, _class3.OptimizationPolicyThreshold = 3, _class3), (_initializer = _applyDecoratedInitializer(_class2.prototype, "data", [serializable, editable], function () {
        return null;
