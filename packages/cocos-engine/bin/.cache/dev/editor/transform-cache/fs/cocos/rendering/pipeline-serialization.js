System.register("q-bundled:///fs/cocos/rendering/pipeline-serialization.js", ["../core/data/decorators/index.js", "../core/index.js", "../gfx/index.js", "../asset/assets/render-texture.js", "../asset/assets/material.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RenderTextureConfig", RenderTextureConfig = (_dec5 = ccclass('RenderTextureConfig'), _dec6 = type(RenderTexture), _dec5(_class4 = (_class5 = class RenderTextureConfig {
        constructor() {
      ...
      _export("MaterialConfig", MaterialConfig = (_dec7 = ccclass('MaterialConfig'), _dec8 = type(Material), _dec7(_class7 = (_class8 = class MaterialConfig {
        constructor() {
      ...
      _export("FrameBufferDesc", FrameBufferDesc = (_dec9 = ccclass('FrameBufferDesc'), _dec10 = type([CCString]), _dec11 = type(RenderTexture), _dec9(_class10 = (_class11 = class FrameBufferDesc {
        constructor() {
      ...
      _export("ColorDesc", ColorDesc = (_dec12 = ccclass('ColorDesc'), _dec13 = type(Format), _dec14 = type(LoadOp), _dec15 = type(StoreOp), _dec16 = type(AccessFlagBit), _dec17 = type(AccessFlagBit), _dec12(_class13 = (_class14 = class ColorDesc {
        constructor() {
      ...
      _export("DepthStencilDesc", DepthStencilDesc = (_dec18 = ccclass('DepthStencilDesc'), _dec19 = type(Format), _dec20 = type(LoadOp), _dec21 = type(StoreOp), _dec22 = type(LoadOp), _dec23 = type(StoreOp), _dec24 = type(AccessFlagBit), _dec25 = type(AccessFlagBit), _dec18(_class16 = (_class17 = class DepthStencilDesc {
        constructor() {
      ...
      _export("RenderPassDesc", RenderPassDesc = (_dec26 = ccclass('RenderPassDesc'), _dec27 = type([ColorDesc]), _dec28 = type(DepthStencilDesc), _dec26(_class19 = (_class20 = class RenderPassDesc {
        constructor() {
       ...
       * @zh 渲染队列描述信息
       */
      _export("RenderQueueDesc", RenderQueueDesc = (_dec29 = ccclass('RenderQueueDesc'), _dec30 = type(RenderQueueSortMode), _dec31 = type([CCString]), _dec29(_class22 = (_class23 = class RenderQueueDesc {
        constructor() {
          /**
