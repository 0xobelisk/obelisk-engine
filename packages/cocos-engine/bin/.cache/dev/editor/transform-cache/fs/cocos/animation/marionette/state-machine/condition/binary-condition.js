System.register("q-bundled:///fs/cocos/animation/marionette/state-machine/condition/binary-condition.js", ["../../../../core/index.js", "../../../define.js", "../../create-eval.js", "../../../../serialization/index.js", "./binding/variable-binding.js", "./binding/runtime.js"], function (_export, _context) {
  ...
  var _decorator, CLASS_NAME_PREFIX_ANIM, createEval, instantiate, TCVariableBinding, BinaryConditionEval, _dec, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _class3, ccclass, serializable, BinaryOperator, BinaryCondition;
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("BinaryCondition", BinaryCondition = (_dec = ccclass(`${CLASS_NAME_PREFIX_ANIM}BinaryCondition`), _dec(_class = (_class2 = (_class3 = class BinaryCondition {
        constructor() {
          /**
           * @zh
           * 运算符。
