System.register("q-bundled:///fs/cocos/scene-graph/node.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "./layers.js", "./node-ui-properties.js", "../core/global-exports.js", "./node-dev.js", "../core/math/index.js", "./node-enum.js", "../core/data/index.js", "../core/platform/debug.js", "./component.js", "../core/data/decorators/property.js", "../core/index.js", "./node-event.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("Node", Node = (_dec = ccclass('cc.Node'), _dec2 = type(Vec3), _dec3 = type(MobilityMode), _dec(_class = (_class2 = (_class3 = class Node extends CCObject {
        // --------------------- legacy BaseNode ---------------------
        /**
        ...
        constructor(name) {
          super(name);
          this._parent = _initializer && _initializer();
          this._children = _initializer2 && _initializer2();
          this._active = _initializer3 && _initializer3();
          this._components = _initializer4 && _initializer4();
          /**
           ...
           */
          this._prefab = _initializer5 && _initializer5();
          this._scene = null;
          ...
          this._static = false;
          // local transform
          this._lpos = _initializer6 && _initializer6();
          this._lrot = _initializer7 && _initializer7();
          this._lscale = _initializer8 && _initializer8();
          this._mobility = _initializer9 && _initializer9();
          this._layer = _initializer10 && _initializer10();
          ...
          this._euler = _initializer11 && _initializer11();
