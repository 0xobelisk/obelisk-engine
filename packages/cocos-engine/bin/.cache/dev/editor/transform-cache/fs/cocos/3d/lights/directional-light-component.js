System.register("q-bundled:///fs/cocos/3d/lights/directional-light-component.js", ["./light-component.js", "../../render-scene/index.js", "../../core/index.js", "../../render-scene/scene/index.js", "../framework/mesh-renderer.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("DirectionalLight", DirectionalLight = (_dec = ccclass('cc.DirectionalLight'), _dec2 = help('i18n:cc.DirectionalLight'), _dec3 = menu('Light/DirectionalLight'), _dec4 = formerlySerializedAs('_illuminance'), _dec5 = tooltip('i18n:lights.illuminance'), _dec6 = range([0, Number.POSITIVE_INFINITY, 10]), _dec7 = type(CCInteger), _dec8 = tooltip('i18n:lights.shadowEnabled'), _dec9 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec10 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 1
        }
      }), _dec11 = type(CCBoolean), _dec12 = tooltip('i18n:lights.shadowPcf'), _dec13 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec14 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 5
        }
      }), _dec15 = type(PCFType), _dec16 = tooltip('i18n:lights.shadowBias'), _dec17 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec18 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 6
        }
      }), _dec19 = type(CCFloat), _dec20 = tooltip('i18n:lights.shadowNormalBias'), _dec21 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec22 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 7
        }
      }), _dec23 = type(CCFloat), _dec24 = tooltip('i18n:lights.shadowSaturation'), _dec25 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec26 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 8
        }
      ...
      }), _dec57 = tooltip('CSM Performance Optimization Mode'), _dec58 = type(CSMOptimizationMode), _dec59 = tooltip('i18n:lights.shadowFixedArea'), _dec60 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec61 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 14
        }
      ...
      }), _dec86 = range([0.0, 0.1, 0.01]), _dec87 = type(CCFloat), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = class DirectionalLight extends Light {
        /**
        ...
        */
        ...
        constructor() {
          ...
          this._shadowEnabled = _initializer3 && _initializer3();
          // Shadow map properties
          this._shadowPcf = _initializer4 && _initializer4();
          this._shadowBias = _initializer5 && _initializer5();
          this._shadowNormalBias = _initializer6 && _initializer6();
          this._shadowSaturation = _initializer7 && _initializer7();
          this._shadowDistance = _initializer8 && _initializer8();
          this._shadowInvisibleOcclusionRange = _initializer9 && _initializer9();
          this._csmLevel = _initializer10 && _initializer10();
          this._csmLayerLambda = _initializer11 && _initializer11();
